...
public class CodigoUsuarioListener implements ActionListener{
	private CodigoUsuarioDialog formulario;
	
	public CodigoUsuarioListener(CodigoUsuarioDialog formulario) {
	...
	public void actionPerformed(ActionEvent event) {
		if(event.getSource().equals(this.formulario.getOk())){
			this.formulario.setLogin(this.formulario.getTBuscar().getText());
